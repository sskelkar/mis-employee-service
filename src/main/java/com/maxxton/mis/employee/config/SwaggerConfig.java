package com.maxxton.mis.employee.config;
...
public class SwaggerConfig {
  ...
  private ApiInfo apiInfo() {
    ApiInfo apiInfo = new ApiInfo("MIS Employee Service API", "MisEmployeeService API", "1.0", null, "P. Bohara (p.bohara@maxxton.com)", null, null);
    return apiInfo;
  }
